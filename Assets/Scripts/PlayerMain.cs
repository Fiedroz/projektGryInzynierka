...
public class PlayerMain : MonoBehaviour
{
    ...
    public IEnumerator BackpackRockets()
    {
        float angle = Random.Range(0f, 2 * Mathf.PI);
        Vector3 spawnPos = GameManager.Instance.playerMovement.spawnTransform.position + new Vector3(Mathf.Cos(angle), 0, Mathf.Sin(angle)) * (15f);
